...
namespace MusicGame.Scene
{
    class Select2:IScene
    {
        ...
        public void Initialize()
        {
            ...
            //最初に回っている
            player = new Player(new Vector2(96 * 7 + 15, 96 * 6 + 15), GameDevice.Instance(), gameObjectManager);
            gameObjectManager.Add(player);

            //最初に止まっている
            player2 = new Player2(new Vector2(96 * 8 + 18, 96 * 6 + 15), GameDevice.Instance(), gameObjectManager);
